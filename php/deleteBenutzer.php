...
*	Löscht alle Zutatstates von Einkaufslisten dieses Benutzers
...
$sql = "DELETE FROM einkaufsliste2zutatstate WHERE einkid IN (SELECT einkid FROM einkaufsliste WHERE userid = $userid)";
if (!($result = mysqli_query($con, $sql)))
{
